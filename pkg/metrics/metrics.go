...
func RegisterMetrics() {
	...
	prometheus.MustRegister(QueryCacheMemoryUsage)
	prometheus.MustRegister(QueryCacheMemLimit)
	prometheus.MustRegister(QueryCacheCount)
	prometheus.MustRegister(QueryCacheDuration)
